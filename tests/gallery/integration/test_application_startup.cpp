...
void TestApplicationStartup::initTestCase()
{
    ...
    m_testDataDir = QStandardPaths::writableLocation(QStandardPaths::TempLocation) + "/QtLucideGalleryTests";
...
void TestApplicationStartup::testResourcesAvailable()
{
    ...
    if (!resourcesFound) {
        qDebug() << "Resources not found in expected locations, but this is acceptable for integration testing";
