...
private:
    ...
    QPixmap createTestPixmap(const QSize& size, const QColor& color, const QString& text = QString());
...
QPixmap TestImageGalleryFunctionality::createTestPixmap(const QSize& size, const QColor& color, const QString& text)
{
    QPixmap pixmap(size);
    pixmap.fill(color);
...
void TestImageGalleryFunctionality::testViewModes()
{
    ...
    QList<ImageViewerWidget::ViewMode> modes = {
        ImageViewerWidget::FitToWindow,
        ImageViewerWidget::FitToWidth,
        ImageViewerWidget::FitToHeight,
        ImageViewerWidget::ActualSize
    };
...
void TestImageGalleryFunctionality::testEndToEndImageViewing()
{
    ...
    QObject::connect(&browser, &FileBrowserWidget::imageSelected,
...
void TestImageGalleryFunctionality::testPerformanceWithLargeDirectory()
{
    ...
    for (int i = 0; i < imageCount; ++i) {
        QPixmap pixmap = createTestPixmap(QSize(200, 200), Qt::blue, QString("Perf Test %1").arg(i));
