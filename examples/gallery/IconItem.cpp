...
IconItem::IconItem(const QString& iconName, 
...
void IconItem::setupAnimations()
{
    ...
    connect(m_hoverAnimation, &QPropertyAnimation::finished,
            this, &IconItem::onHoverAnimationFinished);
}
...
IconItemContainer::IconItemContainer(QWidget *parent) : QWidget(parent), m_itemSize(64), m_displayMode(IconItem::GridMode), m_columns(1), m_spacing(4) {}
void IconItemContainer::addIconItem(IconItem* item) { m_items.append(item); }
void IconItemContainer::removeIconItem(IconItem* item) { m_items.removeOne(item); }
void IconItemContainer::clearItems() { m_items.clear(); }
void IconItemContainer::setItemSize(int size) { m_itemSize = size; }
void IconItemContainer::setDisplayMode(IconItem::DisplayMode mode) { m_displayMode = mode; }
void IconItemContainer::resizeEvent(QResizeEvent *event) { QWidget::resizeEvent(event); updateLayout(); }
